package com.demo.zl.myshadowdemo.utils;
...
import com.demo.zl.myshadowdemo.shadow.Shadow;
import com.demo.zl.myshadowdemo.shadow.ShadowRect;
    ...
    protected void setShape(int shape) {
        switch (shape) {
            case ZDepthShadowLayout.SHAPE_RECT:
                mShadow = new ShadowRect(mContext);
                break;
