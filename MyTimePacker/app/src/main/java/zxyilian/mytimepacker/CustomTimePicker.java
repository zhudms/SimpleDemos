...
public class CustomTimePicker extends TimePicker
{
    ...
    public CustomTimePicker(Context context)
    {
        ...
        try
        {
            ...
            selectionDividerField.set(hourNumberPicker, getResources().getDrawable(R.drawable.dashed_gray));
            selectionDividerField.set(minuteNumberPicker, getResources().getDrawable(R.drawable.dashed_gray));
            selectionDividerField.set(amPmNumberPicker, getResources().getDrawable(R.drawable.dashed_gray));
        }
