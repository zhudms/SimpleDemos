...
public class PullToRefreshLayout extends RelativeLayout {
	...
	/** 是否显示上次刷新时间 */
	private boolean showRefreshTime;
	...
	public void setOnRefreshListener(OnRefreshListener listener,
			boolean showRefreshTime) {
		mListener = listener;
		this.showRefreshTime = showRefreshTime;
	}
...
/*	@Override
	...
	private void initView() {
		...
		refreshTimeTextView = (TextView) refreshView
				.findViewById(R.id.state_time_tv);

		if (showRefreshTime) {
			setRefreshTime();
		} else {
			refreshTimeTextView.setVisibility(View.GONE);
		}
	...
	public void setRefreshTime() {
		...
		refreshTimeTextView.setText(mContext.getString(R.string.refresh_time)
				+ sdf.format(new Date()));
	}
}
